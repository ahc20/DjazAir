...
export const searchFormSchema = z.object({
  origin: z.string().length(3).regex(/^[A-Z]{3}$/, 'Code IATA invalide'),
  destination: z.string().length(3).regex(/^[A-Z]{3}$/, 'Code IATA invalide'),
...
export const localFareAssumptionSchema = z.object({
