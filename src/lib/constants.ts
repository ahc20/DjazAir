...
// Messages et textes
export const LEGAL_DISCLAIMER = "Cette application ne vend pas de billets en dinars algériens et ne réalise aucune opération de change. Les calculs 'via Alger' sont des SIMULATIONS basées sur des hypothèses administrateur ou des saisies utilisateur. Pour réserver, vous serez redirigé vers des canaux officiels. Vérifiez vos conditions de visa et le risque de correspondance.";
